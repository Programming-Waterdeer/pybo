...
from MBE.forms import QuestionForm
from MBE.models import Question, Category
...
def question_create(request, category_name):
    ...
    return render(request, 'MBE/question_form.html', context)
...
def question_modify(request, question_id):
    ...
    if request.user != question.author:
        ...
        return redirect('MBE:detail', question_id=question.id)
    if request.method == "POST":
